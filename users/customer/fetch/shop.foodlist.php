...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function displayFoodListings(foods, resetList = true) {
        ...
        foods.forEach(food => {
            ...
            const healthGoals = food.health_goal_suitable ? food.health_goal_suitable.split(',')[0] :
                'N/A';
    ...
    <div class="product-list-item">
        ...
        <div class="product-details">
            ...
            <div class="product-footer">
                ...
                <a href="product.php?prod=${food.food_id}" class="cart-button">
...
`;
            ...
            }, 50 * (existingTabPane.querySelectorAll('.product-list-item-container').length -
                1));
        });
    ...
    document.querySelectorAll('.nav-link').forEach(button => {
        button.addEventListener('click', function() {
            ...
            const category = this.textContent.trim().replace(
                /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, '');
    ...
    if (applyFiltersBtn) {
        applyFiltersBtn.addEventListener('click', () => {
            ...
            const mealTypeCheckboxes = document.querySelectorAll(
                '.filter-checkbox[data-filter="meal-type"]:checked');
            currentFilters.mealTypes = Array.from(mealTypeCheckboxes).map(cb => cb.value);

            // Get selected diet types
            const dietTypeCheckboxes = document.querySelectorAll(
                '.filter-checkbox[data-filter="diet-type"]:checked');
    ...
    window.addToCart = function(foodId) {
        ...
        const cartBtn = document.querySelector(
            `.product-list-item-container[data-id="${foodId}"] .cart-button`);
        if (cartBtn) {
