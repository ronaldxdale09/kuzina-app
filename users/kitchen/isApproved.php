...
<body>
    ...
    <main class="main-wrap error-404 mb-xxl">
        ...
        <div class="banner-box">
            <img src="assets/images/banner/waiting_vector.svg" class="img-fluid" alt="404" />
        </div>
        <!-- Banner End -->
        ...
        <section class="error mb-large">
            ...
            <p class="content-color font-md">
                Thank you for your interest in joining our community! Your application is currently under review and
                will require a face-to-face assessment. You may receive a call or text soon with details about your
