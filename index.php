...
function isMobile() {
    ...
    // Add more specific checks for common app WebViews
    if (strpos($useragent, 'Android') !== false && strpos($useragent, 'Version') !== false) {
        return true;
    }
    
    // Original mobile detection
...
// Alternative approach: Use URL parameter to force mobile view
if (isset($_GET['app']) || isMobile()) {
