...
<body>
    ...
    <div id="main-content" style="display: <?php echo $showSplash ? 'none' : 'block'; ?>">
            ...
            <section class="login-section p-0">
                ...
                <form id="login-form" class="custom-form form" method="POST">
                    ...
                    <div class="form-group-wrapper">
                        <div class="input-box">
                            <input type="number" id="phone" name="phone" placeholder="Phone Number" required class="form-control" autocomplete="off" />
        ...
        <div class="action action-confirmation offcanvas offcanvas-bottom" tabindex="-1" id="underDev" aria-labelledby="confirmation">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.help-link').forEach(link => {
                link.addEventListener('click', function(e) {
                    e.preventDefault();
                    const underDevModal = new bootstrap.Offcanvas(document.getElementById('underDev'));
                    underDevModal.show();
                });
            });
