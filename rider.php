...
// Check if the 'Rider_user_id' cookie is set and not empty
if (isset($_COOKIE['Rider_user_id']) && !empty($_COOKIE['Rider_user_id'])) {
    // Redirect to Rider dashboard
    header("Location: users/Rider/homepage.php");
    exit();
}
...
<body>
    ...
    <main class="main-wrap login-page login mb-xxl">
        ...
        <section class="login-section p-0">
            ...
            <div class="info-card">
                ...
                <h2>Rider Dashboard Access</h2>
                <p>Manage deliveries, track earnings, and navigate routes efficiently through your dedicated dashboard
                </p>
            </div>
            ...
            <form id="login-form" class="custom-form form" method="POST">
                ...
                <h1 class="font-md title-color fw-600">Rider Partner Login</h1>
                ...
                <!-- Join as Rider Partner -->
                <div class="join-section">
                    <h3>Not a Rider Partner Yet?</h3>
                    <a href="rider.registration.php" class="btn-join join">
                        <i class='bx bx-restaurant'></i>
                ...
                <div class="portal-selection">
                    ...
                    <div class="portal-buttons">
                        ...
                        <a href="kitchen.php" class="portal-btn rider">
                            <i class='bx bx-cycling'></i>
                            Kitchen Portal
                        </a>
                    </div>
    ...
    document.getElementById('login-submit').addEventListener('click', function(e) {
        ...
        fetch('functions/rider.login.php', {
                method: 'POST',
                body: formData
            })
